...
from engine.process.interceptor.ComponentStore.register_html import handle_register_html
from engine.process.interceptor.ComponentStore.register_marker import handle_register_marker
...
class ComponentInterceptor:
    ...
    def intercept(self, text: str, theme_type: str, inner_parser_cb) -> tuple[str, ComponentStore]:
        ...
        def acs_replacer(match):
            ...
            color_map = { 'safe': '#27ae60', 'euclid': '#f1c40f', 'keter': '#c0392b', 'neutralized': '#7f8c8d', 'pending': '#bdc3c7', 'explained': '#95a5a6', 'esoteric': '#595959', '机密': '#595959' }
            ...
            return self.store.register_html(source, "acs", html)
