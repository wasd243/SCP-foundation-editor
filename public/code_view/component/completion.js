            ...
            options: [
                {
                    ...
                    type: "keyword",
                    apply: "<div>\n\n</div>",
                    detail: "block element",
                },
                {
                    label: "<span>",
                    type: "keyword",
                    apply: "<span></span>",
                    detail: "inline element",
                },
                {
                    label: "<style>",
                    type: "keyword",
        ...
        options: [
            ...
            },
            {
                ...
                apply: (view, completion, from, to) => {
                    ...
                    view.dispatch({
                        changes: { from, to, insert: text },
                        selection: {
                            anchor: from + "[[collapsible".length + 8,
            ...
            },
            {
                ...
                apply: (view, completion, from, to) => {
                    ...
                    const selectFrom =
                        from + "[[include component:image-block\n|name=".length;
                    view.dispatch({
                        changes: { from, to, insert: text },
