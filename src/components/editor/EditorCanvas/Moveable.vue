...
const selectedImageResizable = computed(() =>
    Boolean(selectedImageBlockElement.value),
);
    ...
    Boolean(
        ...
        (selectedImageBlockElement.value?.hasAttribute("data-editor-include") &&
            (selectedImageBlockElement.value.classList.contains("alignleft") ||
                selectedImageBlockElement.value.classList.contains(
                    "alignright",
                ) ||
                selectedImageBlockElement.value.classList.contains(
                    "aligncenter",
...
<template>
    <div v-if="imagePositionGuideVisible" class="image-position-guides">
        <div
