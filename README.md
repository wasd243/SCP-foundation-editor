![License](https://img.shields.io/badge/license-MIT-green) ![Status](https://img.shields.io/badge/status-Alpha-orange)
...
> [!IMPORTANT]
> **请务必做好数据备份！**
> 在使用本编辑器时，请不要完全依赖自动保存或稳定性。对于重要的文档稿件，请务必在本地保留副本。
...
* *(可以在这里补充更多功能，例如：一键排版、语法高亮、模板插入等)*
